...
To choose ${meals[2]} (₦2,000), reply with "three"`);
  ...
  delivery =
    prompt(`Your bill is ₦${price}, the delivery charge is ₦${deliveryFee} to make a total of ₦${totalPrice} 
...
Have a great day!`);
  ...
  console.log(
    `That's too bad, we're open everyday, hope to serve you better next time!`
  );
}
